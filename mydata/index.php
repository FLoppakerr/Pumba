      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="report/report_hotels.php">โรงแรม</a></li> <!-- ลิงก์ไปหน้าสรุปรายงานโรงแรม -->
            <li><a href="report/report_business_type.php">ประเภทธุรกิจ</a></li> <!-- ลิงก์ไปหน้าสรุปรายงานประเภทธุรกิจ -->
            <li><a href="report/report_province.php">จังหวัด</a></li> <!-- ลิงก์ไปหน้าสรุปรายงานจังหวัด -->
          </ul>
        </li>
        <!-- ปุ่มเพิ่มข้อมูล -->
