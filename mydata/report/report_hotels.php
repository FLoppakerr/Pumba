  ...
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="../index.php" style="margin:15px;">
        ...
        <h3 style="margin: 0; font-size: 16.4px;">สรุปรายงานโรงแรม</h3>
      </a>
    </div>
    <div class="collapse navbar-collapse">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li>
        <button type="button" class="btn btn-success navbar-btn" onclick="window.location.href='export_hotels.php'">Export CSV</button>
        </li>
        <li class="dropdown">
